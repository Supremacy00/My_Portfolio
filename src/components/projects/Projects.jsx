      ...
      <article className="bg-gray-100 ">
        ...
        <ul className="mx-auto grid gap-8 gap-y-16 mt-8 max-w-full text-gray-900 sm:grid-cols-2 sm:max-w-[825px] md:max-w-[1000px] lg:grid-cols-3 lg:max-w-[1070px] xl:max-w-[1300px]">
          {projectData.map((item) => {
            return (
              <div key={item.id} className="bg-slate-50 rounded-xl shadow-lg  hover:shadow-xl">
                  <LazyLoadImage loading="lazy" src={item.pCardImg} alt="" className="mx-auto object-cover cursor-pointer rounded-xl w-full max-h-[370px] sm:max-h-[230px] lg:max-h-[270px] xl:max-h-[320px]"/>
